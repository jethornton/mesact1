...
def loadini(parent, iniFile, config):
	...
	iniList.append(['SPINDLE_0', 'SPINDLE_TYPE', 'spindleTypeCB'])
	iniList.append(['SPINDLE_0', 'ENCODER_SCALE', 'spindleEncoderScale'])
	iniList.append(['SPINDLE_0', 'SCALE', 'spindleStepScale'])
	iniList.append(['SPINDLE_0', 'SPINDLE_PWM_TYPE', 'spindlePwmTypeCB'])
	iniList.append(['SPINDLE_0', 'PWM_FREQUENCY', 'pwmFrequencySB'])
	iniList.append(['SPINDLE_0', 'MAX_RPM', 'spindleMaxRpm'])
	iniList.append(['SPINDLE_0', 'MIN_RPM', 'spindleMinRpm'])
	iniList.append(['SPINDLE_0', 'DEADBAND', 'deadband_s'])
	iniList.append(['SPINDLE_0', 'FEEDBACK', 'spindleFeedbackCB'])
	iniList.append(['SPINDLE_0', 'P', 'p_s'])
	iniList.append(['SPINDLE_0', 'I', 'i_s'])
	iniList.append(['SPINDLE_0', 'D', 'd_s'])
	iniList.append(['SPINDLE_0', 'FF0', 'ff0_s'])
	iniList.append(['SPINDLE_0', 'FF1', 'ff1_s'])
	iniList.append(['SPINDLE_0', 'FF2', 'ff2_s'])
	iniList.append(['SPINDLE_0', 'BIAS', 'bias_s'])
	iniList.append(['SPINDLE_0', 'MAX_ERROR', 'maxError_s'])
	iniList.append(['SPINDLE_0', 'MAX_OUTPUT', 'maxOutput_s'])
	iniList.append(['SPINDLE_0', 'DRIVE', 'spindleDriveCB'])
	iniList.append(['SPINDLE_0', 'STEPLEN', 'spindleStepTime'])
	iniList.append(['SPINDLE_0', 'STEPSPACE', 'spindleStepSpace'])
	iniList.append(['SPINDLE_0', 'DIRSETUP', 'spindleDirSetup'])
	iniList.append(['SPINDLE_0', 'DIRHOLD', 'spindleDirHold'])
	iniList.append(['SPINDLE_0', 'STEP_INVERT', 'spindleStepInvert'])
	iniList.append(['SPINDLE_0', 'DIR_INVERT', 'spindleDirInvert'])
	iniList.append(['SPINDLE_0', 'MAX_ACCEL_RPM', 'spindleMaxAccel'])
	...
	for item in iniList:
		if config.has_option(item[0], item[1]):
			if isinstance(getattr(parent, item[2]), QLabel):
				...
				if item[1] == 'FIRMWARE':
					index = getattr(parent, item[2]).findText(config[item[0]][item[1]])
				''' There needs to be a way to enter a custom GUI
