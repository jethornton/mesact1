...
def loadini(parent, iniFile, config):
	...
	for i in range(1):
		iniList.append([f'SPINDLE_{i}', 'SPINDLE_TYPE', 'spindleTypeCB'])
		iniList.append([f'SPINDLE_{i}', 'ENCODER_SCALE', 'spindleEncoderScale'])
		iniList.append([f'SPINDLE_{i}', 'SCALE', 'spindleStepScale'])
		iniList.append([f'SPINDLE_{i}', 'SPINDLE_PWM_TYPE', 'spindlePwmTypeCB'])
		iniList.append([f'SPINDLE_{i}', 'PWM_FREQUENCY', 'pwmFrequencySB'])
		iniList.append([f'SPINDLE_{i}', 'MAX_RPM', 'spindleMaxRpm'])
		iniList.append([f'SPINDLE_{i}', 'MIN_RPM', 'spindleMinRpm'])
		iniList.append([f'SPINDLE_{i}', 'DEADBAND', 'deadband_s'])
		iniList.append([f'SPINDLE_{i}', 'FEEDBACK', 'spindleFeedbackCB'])
		iniList.append([f'SPINDLE_{i}', 'P', 'p_s'])
		iniList.append([f'SPINDLE_{i}', 'I', 'i_s'])
		iniList.append([f'SPINDLE_{i}', 'D', 'd_s'])
		iniList.append([f'SPINDLE_{i}', 'FF0', 'ff0_s'])
		iniList.append([f'SPINDLE_{i}', 'FF1', 'ff1_s'])
		iniList.append([f'SPINDLE_{i}', 'FF2', 'ff2_s'])
		iniList.append([f'SPINDLE_{i}', 'BIAS', 'bias_s'])
		iniList.append([f'SPINDLE_{i}', 'MAX_ERROR', 'maxError_s'])
		iniList.append([f'SPINDLE_{i}', 'MAX_OUTPUT', 'maxOutput_s'])
		iniList.append([f'SPINDLE_{i}', 'DRIVE', 'spindleDriveCB'])
		iniList.append([f'SPINDLE_{i}', 'STEPLEN', 'spindleStepTime'])
		iniList.append([f'SPINDLE_{i}', 'STEPSPACE', 'spindleStepSpace'])
		iniList.append([f'SPINDLE_{i}', 'DIRSETUP', 'spindleDirSetup'])
		iniList.append([f'SPINDLE_{i}', 'DIRHOLD', 'spindleDirHold'])
		iniList.append([f'SPINDLE_{i}', 'STEP_INVERT', 'spindleStepInvert'])
		iniList.append([f'SPINDLE_{i}', 'DIR_INVERT', 'spindleDirInvert'])
		iniList.append([f'SPINDLE_{i}', 'MAX_ACCEL_RPM', 'spindleMaxAccel'])
