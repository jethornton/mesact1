...
def daughterCardChanged(parent):
	...
	if parent.sender().currentData():
		...
		axes = {'7i33': 0, '7i47s': 0, '7i47': 0, '7i76': 5, '7i77': 6, '7i78': 4, '7i85': 6, '7i85s': 6, '5ABOB': 5}
		inputs = {'7i33': 0, '7i47s': 0, '7i47': 0, '7i76': '32', '7i77': '32', '7i78': '0', '7i85': 0, '7i85s': 0, '5ABOB': '5'}
		outputs = {'7i33': 4, '7i47s': 0, '7i47': 6, '7i76': '16', '7i77': '16', '7i78': '0', '7i85': 0, '7i85s': 0, '5ABOB': '1'}
		stepper = ['7i76', '7i78']
		servo = ['7i77']
